...
*******************************************************************************/
#ifndef BACKEND_ELYZOR_PATTERNS_PATTERN_UTILS_HPP
#define BACKEND_ELYZOR_PATTERNS_PATTERN_UTILS_HPP
...
#include "graph/backend/elyzor/compiler_backend.hpp"
#include "graph/backend/elyzor/compiler_partition_impl.hpp"
